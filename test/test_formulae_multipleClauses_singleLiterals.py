...
but where each clause involves one literal only.
'''
...
class Test_MultipleClauseFormulae_SingleLiterals_PositiveExamples:
...
class Test_MultipleClauseFormulae_SingleLiterals_NegativeExamples:
    '''
